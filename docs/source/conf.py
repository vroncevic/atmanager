...
Copyright
    ...
    atmanager is distributed in the hope that it will be useful, but
...
htmlhelp_basename: str = 'atmanagerdoc'
latex_elements: Dict[Any, Any] = {}
latex_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'atmanager.tex', 'atmanager Documentation',
    'Vladimir Roncevic \\textless{}elektron.ronca@gmail.com\\textgreater{}',
    'manual'
)]
man_pages: List[Tuple[Any, ...]] = [(
    master_doc, 'atmanager', 'atmanager Documentation', [author], 1
)]
texinfo_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'atmanager', 'atmanager Documentation', author, 'atmanager',
